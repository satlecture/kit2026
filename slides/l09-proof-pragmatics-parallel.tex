...
\begin{frame}{Proof Production: The Parallel Case}
	...
	\pause
	\textbf{2023:} \highl{LRUP-based proofs from clause-sharing solvers} \cite{michaelson2023unsatisfiability}
	\begin{itemize}
...
\vspace*{4mm}
\centering
\includegraphics[width=20cm]{figures/l09/pipes.jpg}\\
...
\begin{minipage}{0.5\textwidth}
	\centering
	\includegraphics[width=0.8\textwidth]{figures/l09/pipe-setup.pdf}
\end{minipage}
...
\hspace*{-6mm}\begin{minipage}[c][8cm][t]{0.95\textwidth}
	\begin{itemize}
		...
		\pause
		\vspace*{5mm}
		\item Checkers \highl{sign} each successfully checked clause $c$ with \highl{cryptographic checksum} based on
		...
		\item Clauses are shared \highl{together with their checksums}
...
\begin{frame}{Real-time Checking: Full Setup}
	\begin{minipage}{0.96\textwidth}%
		\only<1>{\includegraphics[width=\textwidth,page=1,trim=1mm 1mm 1mm 1mm,clip]{figures/l09/realtime-checking-full.pdf}}%
		\only<2>{\includegraphics[width=\textwidth,page=2,trim=1mm 1mm 1mm 1mm,clip]{figures/l09/realtime-checking-full.pdf}}%
		\only<3>{\includegraphics[width=\textwidth,page=3,trim=1mm 1mm 1mm 1mm,clip]{figures/l09/realtime-checking-full.pdf}}%
		\only<4>{\includegraphics[width=\textwidth,page=4,trim=1mm 1mm 1mm 1mm,clip]{figures/l09/realtime-checking-full.pdf}}%
		\only<5>{\includegraphics[width=\textwidth,page=5,trim=1mm 1mm 1mm 1mm,clip]{figures/l09/realtime-checking-full.pdf}}%
		\only<6->{\includegraphics[width=\textwidth,page=6,trim=1mm 1mm 1mm 1mm,clip]{figures/l09/realtime-checking-full.pdf}}%
	\end{minipage}
	\uncover<7->{
		\\[1.5cm]
	$\Rightarrow$ \textbf{We \highl{only} need to trust our checksums and our parser, checkers, and confirmer.}
	\\\phantom{$\Rightarrow$} Not the SAT solvers, not the sharing logic, not the communication, \ldots
	}
\end{frame}
...
\begin{frame}{Recap}
	...
	\begin{block}{Next Up: Applications of SAT solving}
		\begin{itemize}
