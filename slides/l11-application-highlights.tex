...
\begin{frame}{Overview}
	\begin{blueblock}{Selected (!) Application Highlights of SAT}
	\begin{itemize}
...
\begin{frame}{Application Highlights: Takeaways}
	...
	\vspace*{4mm}
	\begin{blueblock}{Next lecture: SMT Solving}
		\begin{itemize}
			\item Satisfiability Modulo Theories (SMT) basics and important theories
			\item SMT solving paradigms: lazy vs.~eager approach
			\item Brief look at SMT-Lib
		\end{itemize}
	\end{blueblock}
\end{frame}
