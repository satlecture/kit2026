...
\begin{frame}{Resolution}
	\begin{block}{Theorem: Resolution is sound}
		...
		\vspace*{-1ex}
		\begin{align*}
			{F \quad \equiv~} \quad F \land \operatorname{R}(C_1,C_2)
		\end{align*}
	\end{block}
	...
	\begin{block}{Proof}
		...
		\textbf{Soundness:} $F \vdash F \land D \implies \highlo{F \models~} F \land D$ \\[.5ex] \pause
		\pause
		...
		\pause
		\textbf{Equivalence:} $F \vdash F \land D \implies F \land D \highlo{~\models F}$ \\[.5ex] \pause
		\pause
