...
\subtitle{Lecture 12 \unimp{\normalfont -- Satisfiability Modulo Theories (SMT)}}
...
\begin{frame}{SMT Solving}
	...
	\begin{itemize}
		\item \textbf{Eager approach}: Find a \highl{direct translation} of $\mathcal{T} \cup F$ to propositional logic; perform \highl{SAT solving}~\cite{brummayer2009boolector}
		\begin{itemize}
		...
		\begin{itemize}
			\item Known as \highl{DPLL($\mathcal{T}$)} in literature~\cite{nieuwenhuis2006solving}
...
\begin{frame}{SMT in Practice}
	...
	\begin{minipage}{0.35\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/l12/smt-example-bv.png}
	\end{minipage}
\end{frame}
...
\begin{frame}{SMT: Concluding Remarks}
	...
	\begin{minipage}{0.5\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/l12/smtlib-logics.png}
	\end{minipage}
\end{frame}
