...
\begin{frame}{Organisation}
	\begin{itemize}\setlength{\itemsep}{1em}
		...
		\item \textbf{7 exercises:} Tuesdays at 3:45 pm, room 301 (starting May 6, every other week)
		...
		\begin{itemize}
			\item \large\url{https://satlecture.github.io/kit2025/}
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}{Organisers}
	\begin{itemize}\setlength{\itemsep}{1em}
		...
		Contact: \href{mailto:iser@kit.edu}{iser@kit.edu}\\[1ex]
...
\begin{example}[McGregor Graph, 110 nodes, planar]
	\textbf{Claim:} Cannot be colored with less than 5 colors. \unimp{(Scientific American, 1975, M.~Gardner's ``Mathematical Games'')}
	\begin{center}
		\includegraphics<1>[height=7.5cm]{figures/l01/macgregor-bw.jpg}
		%\includegraphics<2>[height=4.5cm]{figures/l01/macgregor_arb.jpg}
		\includegraphics<2>[height=7.5cm]{figures/l01/macgregor\_arb-colorblind-friendly.jpg}
	\end{center}
\end{example}
\end{frame}
...
\end{block}~\\
\centering
\href{https://github.com/biotomas/ipasir}{\includegraphics[width=.23\textwidth]{logos/ipasir.png}}
\qquad\qquad\qquad\qquad
\visible<2>{\href{https://github.com/ipasir2}{\includegraphics[width=.23\textwidth]{logos/ipasir2.png}}}%
\end{frame}
...
\begin{frame}{Code Demo: Essential Variables}
Given a CNF formula $F$ over variables $V := \vars{F}$, satifying assignments to $F$ can be partial, i.e., some variables in $V$ are not assigned but still the formula is satisfied.\\[1ex]
